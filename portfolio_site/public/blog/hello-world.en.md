...
This is my first blog post, so I’ll just ramble a bit.
A blog is, by definition, something public — written for people to read. Which means you can’t just dump everything here; the messy thoughts need their own place, either tucked away in `.gitignore` or hidden behind another domain entirely.
