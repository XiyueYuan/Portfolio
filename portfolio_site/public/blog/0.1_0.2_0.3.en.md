...
---
A bit more about the RREF code — it’s actually pretty clever. But when we do RREF by hand with pen and paper, we’re basically following the same logic as a computer. We go column by column, and if `(if abs(A[i, c]) < tol)` — meaning the index number is 0 — then we swap rows.
...
*11/16/2025*  
*Written in the Row 6 / Col 3 cubicle on the left side of the fourth floor of the Reg, University of Chicago*
